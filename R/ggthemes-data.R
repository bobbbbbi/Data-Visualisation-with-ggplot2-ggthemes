...
ggthemes_data <- {
    ...
    # Palette 2
    ptol <- matrix(c('#77AADD', '#4477AA', '#114477',
                           '#77CCCC', '#44AAAA', '#117777',
                           '#88CCAA', '#44AA77', '#117744',
                           '#DDDD77', '#AAAA44', '#777711',
                           '#DDAA77', '#AA7744', '#774411',
                           '#DD7788', '#AA4455', '#771122',
                           '#CC99BB', '#AA4488', '#771155'),
                         nrow = 3, ncol = 7,
                         dimnames = list(c('light', 'medium', 'dark'),
                                         c('azure', 'cyan', 'teal',
                                           'yellow', 'orange', 'red',
                                           'pink')))
    # Palette 1
    ptol1 <- c('#88CCEE', '#332288', '#44AA99', '#117733',
    ...
    x$ptol <-
      list(palette1 = ptol1,
           ...
           rainbow = list(
             c('#40496', '#57A3AD', '#DEA73A', '#D92120'),
             c('#404096',             '#529DB7', '#7DB874', '#E39C37',
             '#D92120'),
             c(
             "#404096",
             "#498CC2",
